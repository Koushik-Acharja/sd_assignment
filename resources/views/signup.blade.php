...
<div id="myModal" class="modal fade">
	<div class="modal-dialog modal-login">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="{{ URL::to('signupStore') }}" method="post">
					...
					<div class="form-group">
						<div class="input-group">
							<span class="input-group-addon"><i class="fa fa-lock"></i></span>
							<input name="confirmpassword" type="password" class="form-control" placeholder="Password" required="required">
						</div>
					</div>
					<div class="form-group">
			...
			<div class="modal-footer">Already Have An Account? <a href="{{ URL::to('/') }}">Click here</a></div>
		</div>
	</div>
</div>
